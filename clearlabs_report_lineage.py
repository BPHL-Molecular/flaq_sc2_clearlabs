...
#Version 1: Uses local containers, VADR for error flags, reports pangolin output in main report
'''
This program takes in ClearLabs fastqs using the ARTIC primer schemes for SARS-CoV-2, bams,
and fastas and generates a read and assembly report along with pangolin lineage.
'''
...
parser = argparse.ArgumentParser(usage='clearlabs_report_lineage.py [options]')
